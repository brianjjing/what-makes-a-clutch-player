...
reg = pd.read_csv("reg_season_pbp_since_2020_21.csv", encoding="latin1")
po  = pd.read_csv("playoffs_pbp_since_2020_21.csv", encoding="latin1")
stats = pd.read_csv("clutch_player_stats_since_2020_21.csv", encoding="latin1")
...
# stats = pd.read_csv("clutch_player_stats_since_2020_21.csv", encoding="latin1", engine="python")
...
# # =========================================
# # 8. Merge into stats and collapse per player (one row)
# # =========================================
...
# Optionally save
final_df.to_csv("combined_marcos_features.csv")
